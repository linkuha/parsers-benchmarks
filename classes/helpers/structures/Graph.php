...
// +-----------------------------------------------------------------------------+
// | Copyright (c) 2003 Sergio Gonsalves Carvalho                                |
// +-----------------------------------------------------------------------------+
...
use helpers\structures\Graph\Node;
 ...
 *
 *
 * @author    Segio Carvalho <sergio.carvalho@portugalmail.com>
...
class Graph
{
     ...
     * @return void
     */
    public function Graph($directed = true)
    {
     ...
     *
     * @param Node $newNode The node to be added.
     *
     * @throws \Exception
     */
        ...
        foreach ($this->_nodes as $key => $node) {
            ...
            */
            ...
            if ($referenceIsEqualFlag) {
                throw new \Exception(
                    'Graph::addNode received an object that is'
     ...
     *
     * @param Node $node The node to be removed from the graph
     *
     * @return void
    ...
    // EXAMPLE
    //	$nonDirectedGraph = new Graph(false);
    //	$node1 = new Node();
